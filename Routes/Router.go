...
func SetupRouter(db *gorm.DB) *gin.Engine {
	...
	api.GET("/front/coupon-branch/:branch_id", middleware.AuthMiddleware(authService, userService), couponHandler.FindAllCouponByBranch)
	...
	//----------------------item api Dasboard-----------------------------
	api.POST("/item/searchAll", middleware.AuthMiddleware(authService, userService), itemHandler.SeachAll)
